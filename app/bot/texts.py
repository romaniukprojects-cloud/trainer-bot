...
TRAINER_LINK_CLEANUP = (
    "⚠️ Твій акаунт було відв'язано від профілю клієнта <b>{name}</b> "
    "(ти випадково перейшов по посиланню клієнта).\n\n"
    "Згенеруй нове посилання для цього клієнта через «🔗 Посилання запрошення»."
)
